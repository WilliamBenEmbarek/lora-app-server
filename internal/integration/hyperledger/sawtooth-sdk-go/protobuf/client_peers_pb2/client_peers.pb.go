...
func init() {
	proto.RegisterFile("github.com/brocaar/lora-app-server/internal/integration/hyperledger/sawtooth-sdk-go/protobuf/client_peers_pb2/client_peers.proto", fileDescriptor_a26b7432d3cd4770)
}
