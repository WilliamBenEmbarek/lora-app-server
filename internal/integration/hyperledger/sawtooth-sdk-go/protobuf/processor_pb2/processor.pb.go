...
func init() {
	proto.RegisterFile("github.com/brocaar/lora-app-server/internal/integration/hyperledger/sawtooth-sdk-go/protobuf/processor_pb2/processor.proto", fileDescriptor_fc0f2af1db5504fc)
}
