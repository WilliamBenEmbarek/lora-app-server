...
func init() {
	proto.RegisterFile("github.com/brocaar/lora-app-server/internal/integration/hyperledger/sawtooth-sdk-go/protobuf/validator_pb2/validator.proto", fileDescriptor_6829a7b19f8a01ed)
}
